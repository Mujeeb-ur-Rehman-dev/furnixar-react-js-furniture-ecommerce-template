        ...
        <div className="s-py-100-50 overflow-hidden">
            <div className="container-fluid">
                <div className="max-w-xl mx-auto mb-8 md:mb-12 text-center" data-aos="fade-up">
                    ...
                    <h3 className="leading-none mt-4 md:mt-6 text-2xl md:text-3xl">Shop by category</h3>
        ...
        <div className="s-py-50-100">
            <div className="container-fluid">
                <div className="max-w-xl mx-auto mb-8 md:mb-12 text-center" data-aos="fade-up">
                    ...
                    <h3 className="leading-none mt-4 md:mt-6 text-2xl md:text-3xl">New Arrivals</h3>
